...
- Traces: the path a request took through distributed services answering where did this slow request spend its time. Example: a trace showing a request spent 800ms waiting for a database query
...
Key design rule: each service owns its own database. Other services access data through APIs, not direct database reads.
...
**Objective**  
Understand why model choice matters using real outcomes.
...
**Expected output**
- Structured comparison with source list

---
### Lab F.C: DevOps Infinity Loop Diagram

**Objective**  
Internalize DevOps lifecycle stages and tools by building a reference diagram.

**What you need**
- Paper or diagram tool like draw.io or Mermaid
- 45 minutes
...
**Expected output**
- PNG, JPG, PDF, or Mermaid diagram that renders correctly
