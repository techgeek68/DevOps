...
**type — type of limit**
 ...
 - hard	- upper ceiling, only the root can raise it
...
**Incident Response Checklist**
 ...
 - Contain:
   - Apply resource limits, kill processes
 - Remediate:
   - Fix root cause, restart services
 - Learn:
   - Document incident, update runbooks
