...
`hostnamectl` writes the hostname persistently. `exec bash` starts a new shell session so the prompt reflects the change immediately.
...
*End of Module 2, Section 2.2: Linux for DevOps*
