...
```
[Source Code:](<Source Code/Part 2 Serve a Static Website: tickets.html>)
...
[Source Code: ](<Source Code/Part 3 Name Based Virtual Hosts: index.html>)
...
---
- **Delete a certificate and a Key:**
...
[Configuration File:](<Source Code/brewhousecafe.local-ssl.conf>)
...
[Configuration File:](<Source Code/attendance.conf>)
...
[Configuration File:](<Source Code/examsite.conf>)
