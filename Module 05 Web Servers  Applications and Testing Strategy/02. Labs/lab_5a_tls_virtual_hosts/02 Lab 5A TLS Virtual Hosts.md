...
Why 825 days? Because this is a private lab CA, the browser's public-trust limits don't apply and you pick the lifetime. Note that 825 days is *not* valid for a publicly trusted certificate: browsers capped those at 398 days in 2020, and the CA/Browser Forum is phasing that down further (200 days from March 2026, reaching 47 by 2029). Public leaf certificates must be short-lived and automated; a private root you control can live much longer, which is why its root runs for ten years above.
