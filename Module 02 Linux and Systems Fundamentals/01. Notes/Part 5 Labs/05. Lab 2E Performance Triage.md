...
**Fig. 30 · Finding the real bottleneck**

![A performance triage separating the real disk saturation cause from three red herrings](images/fig-30-perf-triage.svg)

*The load was disk write saturation; a single busy core, a full page cache, and idle connections all looked alarming but were red herrings.*
